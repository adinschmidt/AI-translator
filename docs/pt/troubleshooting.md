...
- Inicie Ollama, transfira um modelo com `ollama pull llama3.2` e use `http://localhost:11434`. Se a origem for recusada, configure `OLLAMA_ORIGINS` e reinicie. `OLLAMA_ORIGINS="*" ollama serve` permite todas as origens.
