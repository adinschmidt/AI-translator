...
- Para Ollama, inicia el servidor, descarga un modelo con `ollama pull qwen3.5:4b` y usa `http://localhost:11434`. Si rechaza el origen, configura `OLLAMA_ORIGINS` y reinicia. `OLLAMA_ORIGINS="*" ollama serve` permite todos los orígenes.
